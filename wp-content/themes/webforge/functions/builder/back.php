			...
			echo '<div class="mfn-element-content">';
				...
				echo '<div class="mfn-sortable mfn-sortable-row clearfix">';
					...
					if( $section ){
						...
						// FIX | WebForge Builder 2.0 Compatibility						
				...
				echo '<table class="form-table">';
					echo '<tbody>';
						...
						foreach( $section_fields as $field ){
							...
							// PRINT Single WebForge Options FIELD
							if( $section ){
								$input_type = 'existing';
							} else {
								$input_type = 'new';
						...
						<tbody>
							<tr valign="top">
								<td>
									...
									<div class="logo">WebForge Group | WebForge Builder</div>
								</td>
							</tr>
						</tbody>
					</table>
