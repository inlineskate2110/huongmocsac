...
//		    console.log(err);
	...
	jQuery('#content-seo').click(function(){
		...
		if( confirm( "This option is useful for plugins like Yoast SEO to analize post content when you use WebForge Builder.\nIt will collect content from WebForge Builder Elements and copy it into the WordPress Editor.\n\nCurrent Editor Content will be replaced.\nYou can hide the content if you turn \"Hide the content\" option ON.\n\nPlease remember to Publish/Update your post before & after use of this option.\nContinue?" ) ){
