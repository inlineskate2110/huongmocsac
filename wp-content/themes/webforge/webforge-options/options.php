...
//		define('MFN_OPTIONS_URI', site_url(str_replace(ABSPATH, '', trailingslashit(dirname(__FILE__)))));
		define('MFN_OPTIONS_URI', THEME_URI ."/webforge-options/");	
	}
	...
	class MFN_Options{
		...
		function __construct( $menu = array(), $sections = array() ){
			...
			$defaults['opt_name'] 		= 'webforge';
			
			$defaults['menu_icon'] 		= MFN_OPTIONS_URI.'/img/menu_icon.png';
			$defaults['menu_title'] 	= __('WebForge Options', 'mfn-opts');
			$defaults['page_icon'] 		= 'icon-themes';
			$defaults['page_title'] 	= __('WebForge Options', 'mfn-opts');
			$defaults['page_slug'] 		= 'webforge_options';
			...
			echo '<div id="mfn-wrapper">';		
				echo '<form method="post" action="options.php" enctype="multipart/form-data" id="mfn-form-wrapper">';
					...
					echo '<div id="mfn-aside">';
						echo '<div class="mfn-logo">Theme Options - Powered by WebForge Group</div>';
						...
						echo '<div class="mfn-header">';
							echo '<div class="mfn-buttons">';
								...
								echo '<div class="mfn-buttons-more">';
									echo '<a class="mfn-btn-doc"  href="http://www.webforge.site/" target="_blank"><span>Documentation</span></a>';
									echo '<a class="mfn-btn-demo" href="http://www.webforge.site/" target="_blank"><span>Demo</span></a>';
								echo '</div>';
							echo '</div>';
